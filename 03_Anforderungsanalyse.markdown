...
\subfigure[\label{abb:narrowfolksonomy} Narrow Folksonomy]{\includegraphics[width=0.3\textwidth]{img/narrowfolksonomy.png}}\hspace{2cm}
\subfigure[\label{abb:broadfolksonomy} Broad Folksonomy]{\includegraphics[width=0.3\textwidth]{img/broadfolksonomy.png}}
\caption{\label{abb:foksonomies} Vergleich Folksonomien}
\end{figure}
