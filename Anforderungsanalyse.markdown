...
![\label{abb: EingabeC#-API Thesaurus} Eingabe C# - API Thesaurus](img/EingabeCAPIhesaurus.jpg)
...
![\label{abb: RückgabeC#-API Thesaurus} Rückgabe C# - API Thesaurus](img/RueckgabeCAPIThesaurus.jpg)
...
![\label{abb: C#-FunktionGetBaseform} C# - FunktionGetBaseform](img/CFunktionGetBaseform.jpg)
...
![\label{abb: C#-FunktionMain} C# - FunktionMain](img/CFunktionMain.jpg)
...
![\label{abb: RückgabeC#-APIBaseform} Rückgabe C# - APIBaseform](img/RueckgabeCAPIBaseform.jpg)
